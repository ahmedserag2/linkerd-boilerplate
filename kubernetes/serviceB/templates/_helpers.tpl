...
*/}}
{{- define "serviceb.servicebccountName" -}}
{{- if .Values.servicebccount.create }}
{{- default (include "serviceb.fullname" .) .Values.servicebccount.name }}
{{- else }}
{{- default "default" .Values.servicebccount.name }}
{{- end }}
{{- end }}
